...
namespace ContosoExpenses.Data.Services
{
    public class DatabaseService: IDatabaseService
    {
        ...
        private string _filePath = $"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\ContosoExpenses\\data.db";
        private string _directoryPath = $"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\ContosoExpenses\\";
        ...
        public void InitializeDatabase()
        {
            ...
            using (var connection = new LiteDatabase(_filePath))
            {
                ...
                if (result == 0)
                {
                    GenerateFakeData(_numberOfEmployees, _numberOfExpenses);
                }
            }
        }
